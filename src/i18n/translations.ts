...
export const translations: Translations = {
  ...
  'admin.toast.editorialExported':       { he: 'ייוצא: {{items}} פריטים, {{series}} קורסים',                                    en: 'Exported {{items}} items, {{series}} courses',                                es: 'Exportado: {{items}} elementos, {{series}} cursos' },
  ...
  'admin.global.importConfirm':          { he: 'פעולה זו תחליף את כל המטא העריכתית הנוכחית ב-{{items}} פריטים ו-{{series}} קורסים מהקובץ. להמשיך?', en: 'This will replace all current editorial metadata with {{items}} items and {{series}} courses from the file. Continue?', es: 'Esto reemplazará todos los metadatos editoriales actuales con {{items}} elementos y {{series}} cursos del archivo. ¿Continuar?' },
  'admin.toast.editorialImported':       { he: 'יובאו: {{items}} פריטים, {{series}} קורסים',                                    en: 'Imported {{items}} items, {{series}} courses',                                es: 'Importado: {{items}} elementos, {{series}} cursos' },
  ...
  'admin.field.seriesName':              { he: 'שם הקורס',                                                       en: 'Course name',                                                         es: 'Nombre del curso' },
  ...
  'admin.modal.headingSeries':           { he: 'מחיקת קורס',                                                                             en: 'Delete course',                                                        es: 'Eliminar curso' },
  'admin.modal.bodySeries':              { he: 'האם אתה בטוח שברצונך למחוק את הקורס {{title}}?',                                         en: 'Are you sure you want to delete the course {{title}}?',                es: '¿Estás seguro de que quieres eliminar el curso {{title}}?' },
  'admin.modal.warningSeries':           { he: 'הספרים בקורס לא יימחקו, אבל יאבדו את השיוך לקורס. הפעולה אינה ניתנת לביטול.',              en: 'Books in the course will be detached from it but not deleted. This action cannot be undone.', es: 'Los libros del curso quedarán desvinculados pero no se eliminarán. Esta acción no se puede deshacer.' },
  ...
  'admin.column.series':                 { he: 'קורס',           en: 'Course',       es: 'Curso' },
  ...
  'admin.cell.noSeries':                 { he: 'ללא קורס',       en: 'No course',    es: 'Sin curso' },
  ...
  'admin.series.section':                  { he: 'ניהול קורסים',                                                                            en: 'Course Management',                                                                  es: 'Gestión de cursos' },
  'admin.series.empty':                    { he: 'עדיין לא הוגדרו קורסים.',                                                                en: 'No courses defined yet.',                                                             es: 'Aún no hay cursos definidos.' },
  'admin.series.count':                    { he: '{{n}} קורסים',                                                                            en: '{{n}} courses',                                                                       es: '{{n}} cursos' },
  ...
  'admin.series.editAriaLabel':            { he: 'עריכת קורס {{name}}',                                                                    en: 'Edit course {{name}}',                                                               es: 'Editar curso {{name}}' },
  'admin.series.editTitle':                { he: 'עריכת קורס',                                                                             en: 'Edit course',                                                                        es: 'Editar curso' },
  'admin.series.tagCapsule':               { he: 'קפסולה',                                                                                en: 'Capsule',                                                                            es: 'Cápsula' },

  'admin.series.drawer.eyebrow':           { he: 'עריכת קורס',                                                                             en: 'Edit course',                                                                        es: 'Editar curso' },
  ...
  'admin.series.field.displayTitleHint':   { he: 'כיצד הקורס יופיע במרחב הידע.',                                                          en: 'How this course appears in the Knowledge Universe.',                                 es: 'Cómo aparecerá este curso en el Espacio de conocimiento.' },
  ...
  'admin.series.field.visibleInUniverse':  { he: 'גלוי במרחב הידע',                                                                      en: 'Visible in universe',                                                                es: 'Visible en el Espacio' },
  'admin.series.field.visibleHint':        { he: 'כיבוי מסתיר את הקורס ממרחב הידע.',                                                       en: 'Off hides this course from the Knowledge Universe.',                                 es: 'Apagado oculta este curso del Espacio de conocimiento.' },
  'admin.series.field.visibleAria':        { he: 'החלפת גלויות קורס',                                                                     en: 'Toggle course visibility',                                                           es: 'Alternar visibilidad del curso' },
  ...
  'admin.series.button.save':              { he: 'שמירת קורס',                                                                            en: 'Save course',                                                                        es: 'Guardar curso' },
  'admin.series.toast.saved':              { he: 'הקורס "{{name}}" נשמר',                                                                en: 'Course "{{name}}" saved',                                                            es: 'Curso "{{name}}" guardado' },
  ...
  // stay aligned.
  'admin.series.action.new':               { he: 'קורס חדש',                                                                              en: 'New course',                                                                         es: 'Nuevo curso' },
  'admin.series.action.delete':            { he: 'מחיקה',                                                                                  en: 'Delete',                                                                             es: 'Eliminar' },
  'admin.series.action.deleteAriaLabel':   { he: 'מחיקת קורס {{name}}',                                                                    en: 'Delete course {{name}}',                                                             es: 'Eliminar curso {{name}}' },
  'admin.series.action.deleteTitle':       { he: 'מחיקת קורס',                                                                             en: 'Delete course',                                                                      es: 'Eliminar curso' },
  'admin.series.drawer.eyebrowNew':        { he: 'יצירת קורס',                                                                             en: 'Create course',                                                                      es: 'Crear curso' },
  'admin.series.field.name':               { he: 'מזהה הקורס',                                                                             en: 'Course identifier',                                                                  es: 'Identificador del curso' },
  'admin.series.field.nameHint':           { he: 'מחרוזת ייחודית; משמשת לקיבוץ ספרים תחת אותו קורס.',                                       en: 'Unique string; used to group books under the same course.',                          es: 'Cadena única; se usa para agrupar libros bajo el mismo curso.' },
  'admin.series.toast.deleted':            { he: 'הקורס "{{name}}" נמחק',                                                                en: 'Course "{{name}}" deleted',                                                          es: 'Curso "{{name}}" eliminado' },
  'admin.series.toast.created':            { he: 'הקורס "{{name}}" נוצר',                                                                en: 'Course "{{name}}" created',                                                          es: 'Curso "{{name}}" creado' },
  'admin.series.toast.renamed':            { he: 'הקורס שונה ל-"{{name}}"',                                                              en: 'Course renamed to "{{name}}"',                                                       es: 'Curso renombrado a "{{name}}"' },
  'admin.series.toast.alreadyExists':      { he: 'קורס בשם "{{name}}" כבר קיים',                                                          en: 'A course named "{{name}}" already exists',                                           es: 'Ya existe un curso llamado "{{name}}"' },
  'admin.series.toast.nameRequired':       { he: 'נדרש מזהה לקורס',                                                                       en: 'A course identifier is required',                                                    es: 'Se requiere un identificador de curso' },

  // Section header — subtitle below "ניהול סדרות".
  'admin.series.subtitle':                 { he: 'קורסים מייצגים מסלולי לימוד ואוספי ספרים במרחב הידע.',                            en: 'Courses represent learning paths and book collections in the Knowledge Space.', es: 'Los cursos representan rutas de aprendizaje y colecciones de libros en el Espacio de conocimiento.' },
  ...
  'admin.series.card.editButton':          { he: 'עריכת קורס',                                                                             en: 'Edit course',                                                                        es: 'Editar curso' },
  'admin.series.card.noDescription':       { he: 'אין תיאור לקורס זה.',                                                                    en: 'No description for this course.',                                                    es: 'Sin descripción para este curso.' },
  ...
  'admin.series.badge.visible':            { he: 'מוצג במרחב',                                                                            en: 'Shown in universe',                                                                  es: 'Visible en el Espacio' },
  'admin.series.badge.hiddenFromUniverse': { he: 'מוסתר מהמרחב',                                                                          en: 'Hidden from universe',                                                               es: 'Oculto del Espacio' },
  ...
  'admin.series.field.slug':               { he: 'מזהה הקורס',                                                                             en: 'Course identifier',                                                                  es: 'Identificador del curso' },
  'admin.series.field.slugHint':           { he: 'המחרוזת הפנימית שמקשרת ספרים לקורס. שינוי הערך כאן יעדכן את כל הספרים בקורס אוטומטית.',     en: 'Internal string that links books to this course. Editing it here renames the course and retags every attached book.', es: 'Cadena interna que vincula los libros con este curso. Editarla aquí renombra el curso y reetiqueta cada libro vinculado.' },
  'admin.series.field.shortDescription':   { he: 'תיאור קצר',                                                                             en: 'Short description',                                                                  es: 'Descripción breve' },
  'admin.series.field.shortDescriptionHint':{ he: 'משפט אחד שמופיע על כרטיס הקורס.',                                                       en: 'One-line tagline shown on the course card.',                                         es: 'Lema de una línea que aparece en la tarjeta del curso.' },
  'admin.series.field.fullDescription':    { he: 'תיאור מלא',                                                                             en: 'Full description',                                                                   es: 'Descripción completa' },
  'admin.series.field.fullDescriptionHint':{ he: 'פסקה ארוכה לתצוגת הקורס במלואו.',                                                         en: 'Long-form paragraph for the focused course view.',                                   es: 'Párrafo extenso para la vista detallada del curso.' },
  ...
  'admin.series.column.name':              { he: 'שם קורס',                                                                               en: 'Course',                                                                             es: 'Curso' },
