...
export const translations: Translations = {
  ...
  'admin.global.catalogNoticeDescription':{ he: 'שינויים ב-Admin נשמרים כטיוטה מקומית. כדי לפרסם, ייצא catalog.json והחלף את src/data/library/catalog.json.', en: 'Admin changes are saved as a local draft. To publish, export catalog.json and replace src/data/library/catalog.json.', es: 'Los cambios del Admin se guardan como borrador local. Para publicar, exporta catalog.json y reemplaza src/data/library/catalog.json.' },
