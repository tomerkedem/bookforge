# תרגול - עבודה מעשית עם LLMs

להלן שני תרגילים שמטרתם לקחת את כל הרעיונות שנלמדו בשיעור ולהפוך אותם לתרגול מעשי אמיתי.
...
כדי לשמור על סדר והפרדה בין קבצי ההדגמה לבין התרגילים, ניצור תיקיית homework נפרדת בתוך הפרויקט.
...
כדאי לעבוד בצורה מסודרת כבר מההתחלה.
